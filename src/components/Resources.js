...
const resuorcesbtn1 = { backgroundColor: '#EA6320', borderColor: '#EA6320',color:'white'}
...
class Resources extends Component {
  ...
  <div className="container-fluid fluid">
   ...
   <div className="col-sm-12 col-md-12 col-xs-12">
	 ...
	 <div className="col-sm-12 col-md-12 col-xs-12">
		<h4 className="Agenda">Resources</h4>
      ...
      <div className="col-md-12">
       <div className="row col-md-10 resource_contant col-md-onset-2">
			 <table className="table_resource" width="600px">
					<tr>
						<td><p className="resource_utenim">Ut enim ad minim veniam, quis nostrud</p></td>
            <td className="">
					       <a href="" class="agenda_anchar_tag ">
                 <h6 className="agenda_download_presentation panel_anchar resource_anchar"><img src={["./images/panel/Layer 8.png"]} className="pdf_images" alt="pdf file" width="20px" height="15px" />
                 &nbsp;Download Presentation</h6></a>
						</td>
					</tr>	
		  	</table>				
      </div>
			<div className="row col-md-10 resource_contant col-md-onset-2">
			 <table className="table_resource1" width="600px">
					<tr>
						<td><p className="resource_utenim">Ut enim ad minim veniam, quis nostrud</p></td>
            <td className="">
					       <a href="" class="agenda_anchar_tag ">
	 ...
	 <div className="resource_spaces"></div>
