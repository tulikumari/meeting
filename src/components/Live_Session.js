...
class Live_Session extends Component {
	state = {
		valueSingle: '3',
		valueMultiple: ['3', '5'],
	  };
  ...
  <div className="container-fluid fluid">
   <div className="row background-images"> 
	 <div className="col-sm-12 col-md-12 col-xs-12">
		   ...
		   <div className="col-sm-12 col-md-12 col-xs-12 " >
        <b className="Agenda">What one word would you use to sum up...........</b>  
	     </div>
      <div className="col-12 col-md-12 col-sm-10">
       <div className="row col-sm-9 from_live">
        <div className="col-sm-8">
           <table><tr><td><FormControl
             type="text"
             value={this.state.value}
             className="textlive"
             onChange={this.handleChange}
            /></td><td>
       <Button bsStyle="success submit_live">Submit</Button></td></tr></table>
       </div>   
      </div>
      </div>
       ...
       <div className="row col-md-12 col-sm-12">
        <h6 className="submitquestion1 livesession_footer">
