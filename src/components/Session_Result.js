...
class Session_Result extends Component {
	state = {
		valueSingle: '3',
		valueMultiple: ['3', '5'],
	  };
  ...
  <div className="container-fluid fluid">
   <div className="row background-images"> 
	 <div className="col-sm-12 col-md-12 col-xs-12">
		   ...
		   <div className="col-sm-12 col-md-12 col-xs-12 " >
        <b className="Agenda">This Would the Next Questions.? <span className="result">Result</span></b>  
	     </div>
      <div className="col-12 col-md-12 col-sm-10">
       <div className="row">
        <div className="col-sm-4 col-md-4 ">
        <img src={["./images/session/Layer_17.png"]} alt="result" className="sessionresult_contant" width="186px" height="186px" />
       </div>
       <div className="col-sm-8 col-md-8 sessionresult_ul">
        <ul className="">
         <li className="sessionresult_li sessionresult_li1"><span>Question answer option one</span></li>
         <li className="sessionresult_li sessionresult_li2"><span>Question answer option two</span></li>
         <li className="sessionresult_li sessionresult_li3"><span>Question answer option three</span></li>
         <li className="sessionresult_li sessionresult_li4"><span>Question answer option four</span></li>    
        </ul>
       </div>   
      </div>
      </div>
			<div className="col-md-12 col-sm-12 ">
       <div className="row col-md-12 sessionresult_margin">
