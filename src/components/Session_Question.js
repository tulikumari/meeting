...
class Session_Question extends Component {
	state = {
		valueSingle: '3',
		valueMultiple: ['3', '5'],
	  };
  ...
  <div className="container-fluid fluid">
   <div className="row background-images"> 
	 ...
	 <div className="col-sm-12 col-md-12 col-xs-12 " >
	      <br/>
        <b className="Agenda">This Would the Next Questions.?</b>  
				
	 </div>
      <div className="col-md-6 col-sm-6 ">
       <div className="row col-md-6 col-sm-6 sesson_question ">
        <div className="col-md-3 col-sm-2" >
        <h5>Yes</h5>
        </div>
        <div className="col-md-3 col-sm-2" style={styles.block}>
           <MuiThemeProvider  >	
           <Checkbox
        ...
        <div className="col-md-2 col-sm-3" style={styles.block}>
           <MuiThemeProvider  >	
           <Checkbox
          style={styles.checkbox}
           />
...
export default Session_Question;
